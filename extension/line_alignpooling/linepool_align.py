...
from extension.line_alignpooling.jit import linepoolalign
#import linepoolalign
class _LinePoolAlign(Function):
    @staticmethod
    def forward(ctx, input, roi, output_size, spatial_scale):
        ...
        total_output = linepoolalign.forward(
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = linepoolalign.backward(
            grad_output,
            rois,
            con_idx_x,
            con_idx_y,
...
class LinePoolAlign(nn.Module):
    def __init__(self, output_size, spatial_scale):
        super(LinePoolAlign, self).__init__()
...
if __name__ == '__main__':
    ...
    rroi_pool = LinePoolAlign((100, 100), 1.0/1)
